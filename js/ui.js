...
export function fadeOutElements() {
    ...
    elementsToFade.forEach(el => {
        if (el) {
            // RIMOSSA impostazione transizione inline
            // el.style.transition = `opacity ${config.finalFadeOutDuration}s ease-out`;
            el.classList.add(config.classes.fadeOutFinal); // Aggiunge solo la classe
        }
    });
     updatePromptDisplay();
